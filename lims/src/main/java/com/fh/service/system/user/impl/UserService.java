...
public class UserService implements UserManager{
	...
	@Override
	public PageData findNameById(String pd) throws Exception {
		return (PageData)dao.findForObject("UserMapper.findById", pd);
	}
	...
	public List<PageData> findName(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.findName", pd);
	}

	@Override
	public List<PageData> findAllName(Page page) throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.findAllName", page);
	}
}
