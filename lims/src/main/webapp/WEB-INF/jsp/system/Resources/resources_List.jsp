                                          ...
                                          <%--  <c:if test="${QX.cha == 1 }">--%>
                                                <c:forEach items="${list}" var="list" varStatus="vs">
                                                    <tr>
                                                        ...
                                                        <td class="center">${list.lims_resource }</td>
                                                        <td class="center">${list.lims_path }</td>
                                                        <td class="center">
...
<script type="text/javascript">
    ...
    function delUser(ID){
        bootbox.confirm("确定要删除本条记录吗?", function(result) {
            if (result){
                top.jzts();
                var url = "<%=basePath%>resources/del.do?id="+ID;
    ...
    function add(){
        ...
        diag.Drag=true;
        diag.Title ="新增";
        diag.URL = '<%=basePath%>resources/goAddU.do';
        diag.Width = 469;
        diag.Height = 169;
    ...
    function editUser(id){
        ...
        diag.Drag=true;
        diag.Title ="资料";
        diag.URL = '<%=basePath%>resources/goEditU.do?id='+id;
        diag.Width = 469;
        diag.Height = 180;
        diag.CancelEvent = function(){ //关闭事件
            if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
