						...
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										<c:if test="${fx != 'head'}">
										<tr>
											<td style="width:90px;text-align: right;padding-top: 13px;">主职角色:</td>
											<td id="juese">
										...
										<c:if test="${fx != 'head'}">
										<tr>
											<td style="width:90px;text-align: right;padding-top: 13px;">副职角色:</td>
											<td>
											<div>
										...
										<tr>
											<td style="width:90px;text-align: right;padding-top: 13px;">职业:</td>
											<td>
												<select  name="PROSITON_CATEGORY" id="PROSITON_CATEGORY" style="vertical-align:top;width:98%;" >
													<option value ="" disabled selected style='display:none;'>请选择职业</option>
										...
										<tr>
											<td style="width:90px;text-align: right;padding-top: 13px;">职业状态:</td>
											<td>
												<select  name="POSITION_STATUS" id="POSITION_STATUS" style="vertical-align:top;width:98%;" >
													<option value ="" disabled selected style='display:none;'>请选择职业状态</option>
													<option value ="1" <c:if test="${pd.PROSITON_CATEGORY == '1'}">selected</c:if>>在职</option>
													<option value ="2" <c:if test="${pd.PROSITON_CATEGORY == '2'}">selected</c:if>>离职</option>
												</select>
											</td>
										</tr>
										<tr>
										...
										<c:if test="${fx != 'head'}">
										<tr>
											<td style="width:90px;text-align: right;padding-top: 13px;">管理员密码:</td>
											<td><input type="password" name="adminpassword" id="adminpassword" placeholder="这里输入管理员密码" maxlength="32" title="管理员密码" style="width:98%;"/></td>
										</tr>
										</c:if>
										<tr>
...
<script type="text/javascript">
	...
	function save(){
        ...
        if($("#POSITION_STATUS").val()==null || $("#POSITION_STATUS").val()==""){
            $("#POSITION_STATUS").tips({
                side:3,
                msg:'选择职业状态',
                bg:'#AE81FF',
                time:3
        ...
        if($("#PROSITON_CATEGORY").val()==null || $("#PROSITON_CATEGORY").val()==""){
            $("#PROSITON_CATEGORY").tips({
                side:3,
                msg:'选择职位',
                bg:'#AE81FF',
                time:3
            });
            $("#PROSITON_CATEGORY").focus();
            return false;
        }
