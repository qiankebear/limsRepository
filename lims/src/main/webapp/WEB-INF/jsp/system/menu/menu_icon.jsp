				...
				<div class="page-content">
					...
					<div class="row">
						...
						<table id="dynamic-table" class="table table-striped table-bordered">
							...
							<tr class="center" style="cursor:pointer;">
								<td><label onclick="seticon('menu-icon iconfont ift-bianjiqi ');"><i class="menu-icon iconfont ift-bianjiqi "></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-shiyong ');"><i class="menu-icon iconfont ift-shiyong "></i>&nbsp;&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-zengjia ');"><i class="menu-icon iconfont ift-zengjia "></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-kongjing ');"><i class="menu-icon iconfont ift-kongjing "></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-tongji ');"><i class="menu-icon iconfont ift-tongji "></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-programming__easyiftnet ');"><i class="menu-icon iconfont ift-programming__easyiftnet "></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-rizhi ');"><i class="menu-icon iconfont ift-rizhi"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-daiban-fuben_fuzhi ');"><i class="menu-icon iconfont ift-daiban-fuben_fuzhi"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-churuku- ');"><i class="menu-icon iconfont ift-churuku-"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-shijiguiguanliman ');"><i class="menu-icon iconfont ift-shijiguiguanliman"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-huanyuan ');"><i class="menu-icon iconfont ift-huanyuan"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-zhineng ');"><i class="menu-icon iconfont ift-zhineng"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-SOP ');"><i class="menu-icon iconfont ift-SOP"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-tongyidakong ');"><i class="menu-icon iconfont ift-tongyidakong"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-fenxi ');"><i class="menu-icon iconfont ift-fenxi"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-xiaji ');"><i class="menu-icon iconfont ift-xiaji"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-jiancexitong ');"><i class="menu-icon iconfont ift-jiancexitong"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-toggle ');"><i class="menu-icon iconfont ift-toggle"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-shangjitongji ');"><i class="menu-icon iconfont ift-shangjitongji"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
							</tr>
							<tr class="center" style="cursor:pointer;">
								<td><label onclick="seticon('menu-icon iconfont ift-DNAkuozeng- ');"><i class="menu-icon iconfont ift-DNAkuozeng-"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon iconfont ift-performance-monitoring ');"><i class="menu-icon iconfont ift-performance-monitoring"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
							</tr>
							<tr>
