			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="kitsmanager/${msg }.do" name="Form" id="Form" method="post">
								...
								<table id="table_report" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td><select  class="chosen-select form-control" name="KIT_TYPE" id="KIT_TYPE">
											...
											<option value ="1" <c:if test="${pd.KIT_TYPE=='1'}">selected</c:if>>常染色体</option>
											<option value ="2" <c:if test="${pd.KIT_TYPE=='2'}">selected</c:if>>X染色体</option>
											<option value ="3" <c:if test="${pd.KIT_TYPE=='3'}">selected</c:if>>Y染色体</option>
											<option value ="4" <c:if test="${pd.KIT_TYPE=='4'}">selected</c:if>>其他</option>
										</select></td>
									</tr>
									<tr>
